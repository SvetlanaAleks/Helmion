    ...
    g[h] = {
        ...
        helpers: {
            ...
            clone: function clone(b) {
                if (b == null || (typeof b === "undefined" ? "undefined" : _typeof(b)) !== "object") return b;
        ...
        events: {
            memoryLeaking: false,
            listeners: [],
            addListener: function addListener(b, a, c) {
                if (b.addEventListener) b.addEventListener(a, c, false);else if (b.attachEvent) {
                    this.listeners.push(b);
                    if (!this.memoryLeaking) {
                        window.attachEvent("onunload", function () {
                            if (this.listeners) for (var d = 0, e = this.listeners.length; d < e; d++) {
            ...
            purge: function (_purge) {
                ...
                }if (a = b.childNodes) for (c = 0; c < a.length; c += 1) {
...
//# sourceMappingURL=../maps/audio.js.map
